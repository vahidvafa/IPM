                                    ...
                                    <table class="table table-responsive col-12">
                                        ...
                                        @foreach($user->orders as $pay)
                                            <tr class="table-@switch($pay->state_id) @case(0)light @break @case(1)success @break @case(2)danger @break @endswitch " >
                                                ...
                                                <td><button class="btn btn-white-border" data-toggle="modal" data-target="#order-code" data-extra="{{$pay->ordercodes}}" >نمایش</button></td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    </table>
            ...
            <div class="modal-content">
                ...
                <form class="sidebar-form-body" action="http://ipma.vahidizadyar.ir/user/update" method="POST"
                    ...
                    <div class="modal-body form-profile">
                        <div class="row">
                            ...
                            <div class="input-form col-lg-6">
                                ...
                                <input type="text" id="profile[youTube]" name="profile[youTube]" size="40" aria-invalid="false"
                                       placeholder="لینک یوتویوپ"
                                       value="https://youTube.com/Tevin-O&#039;Reilly"
                                       required>
                            ...
                            <div class="input-form col-lg-6">
                                ...
                                <input type="text" id="profile[facebook]" name="profile[facebook]" size="40" aria-invalid="false"
                                       placeholder="لینک فیسبوک"
                                       value="https://facebook.com/Tevin-O&#039;Reilly"
                                       required>
                            ...
                            <div class="input-form col-lg-6">
                                ...
                                <input type="text" id="profile[instagram]" name="profile[instagram]" size="40" aria-invalid="false"
                                       placeholder="لینک اینستاگرام"
                                       value="https://instagram.com/Tevin-O&#039;Reilly"
                                       required>
                            ...
                            <div class="input-form col-lg-6">
                                ...
                                <input type="text" id="profile[telegram]" name="profile[telegram]" size="40" aria-invalid="false"
                                       placeholder="لینک تلگرام"
                                       value="https://telegram.com/Tevin-O&#039;Reilly"
                                       required>
                            ...
                            <div class="input-form col-lg-6">
                                ...
                                <input type="text" id="profile[twitter]" name="profile[twitter]" size="40" aria-invalid="false"
                                       placeholder="لینک تویتر"
                                       value="https://twitter.com/Tevin-O&#039;Reilly"
                                       required>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn form-submit-violet submin-modal text-white font-16 text-medium">ذخیره تغییرات</button>
                    </div>
                </form>
            </div>
        </div>
