                ...
                <div class="row">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12">
                        <div class="card card-stats">
                            ...
                            <div class="card-body">
                                <form action="{{route('imageGallery.update',[$img->id])}}" method="post"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 mb-4">
                                            ...
                                            <input type="url" class="form-control" name="url" value="{{old('url')??$img->url}}"  >
                                            @if ($errors->has('url'))
                                                <div id="title-error"
                                    ...
                                    <h3  class="mt-5" >عکس موجود در سایت</h3>
                                    <img style="max-height: 450px;max-width: 450px" src="{{asset("img/image_archive")}}/{{$img->photo}}" />
