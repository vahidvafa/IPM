        ...
        <div class="card">
            ...
            <div id="menu0" class="card-body">
                <form class="sidebar-form-body row"
                      action="{{route('PassedCourses.update',[$PassedCourse->id])}}" method="post"
                ...
                >
                    ...
                    <div class="form-group col-12 mb-4">
                        ...
                        <select name="passed_courses_category_id" class=" col-4 form-control selectpicker"
                    ...
                    <div class="form-group col-md-12 mb-4 ">
                        ...
                        <input type="text" name="title" id="title" class="form-control"
                               value="{{old('title')??$PassedCourse->title}}"
                               aria-invalid="false"
                               required>
                        @if ($errors->has('title'))
                            <div id="title-error"
