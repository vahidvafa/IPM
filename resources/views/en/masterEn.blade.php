...
<header id="header">
    <div class="header-top-bar back-dark-violet pt-3 pb-3" style="direction: ltr;text-align: left">
        <div class="container">
            <div class="row">
    ...
    <div class="sidebar-pages " style="direction: ltr;">
        ...
        <div class="slider-text-page pt-2 pt-lg-2 mt-lg-2">
            <div class="container">
                <div class="row justify-content-end">
                    <div class="col-12">
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item font-20"><a href="/"> Home </a></li>
                            <li class="breadcrumb-item font-20 active"> {{$breadcrumb??''}} </li>
                        </ul>
                        <h1 class="title-page font-40 text-white"
                            style="display: block;text-overflow: ellipsis;word-wrap: break-word;overflow: hidden;max-height: 1.3em;line-height: 1.3em;text-align: left;">{{$titleHeader ?? ''}}</h1>
    ...
    <div class="container">
        ...
        <div class="footer-copy row align-items-center pt-4 pb-3">
            ...
            <div class="col-12 col-lg-6 ">
                <ul class="social m-0 text-center text-lg-left">
