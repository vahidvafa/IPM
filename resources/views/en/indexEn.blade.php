...
<header id="header">
    <div class="header-top-bar back-dark-violet pt-3 pb-3" style="direction: ltr;text-align: left">
        <div class="container">
            <div class="row">
                <div class="col-8 col-md-8 d-lg-flex align-items-center pl-0">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-2">
                    <a href="{{route("news.en")}}" class="btn btn-white-border">News Archive</a>
                </div>
            </div>
            <div class="row mt-5">
